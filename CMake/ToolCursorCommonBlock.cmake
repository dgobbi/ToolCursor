...
if(BUILD_PYTHON_WRAPPERS)
  ...
  if(TOOLCURSOR_PYTHON_LIBRARIES)
...
install(TARGETS
  ...
  EXPORT ToolCursorTargets
  RUNTIME DESTINATION ${TOOLCURSOR_RUNTIME_INSTALL_DEST} COMPONENT RuntimeLibraries
  LIBRARY DESTINATION ${TOOLCURSOR_LIBRARY_INSTALL_DEST} COMPONENT RuntimeLibraries
  ARCHIVE DESTINATION ${TOOLCURSOR_ARCHIVE_INSTALL_DEST} COMPONENT Development)

install(FILES ${LIB_HDRS}
  DESTINATION ${TOOLCURSOR_INCLUDE_INSTALL_DEST} COMPONENT Development)
